...
public class HorizontalDottedProgress extends View {
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        paint.setColor(Color.parseColor("#6a7180"));
    ...
    private void createDot(Canvas canvas, Paint paint)
    {
        ...
        {
            if(i == mDotPosition){
                canvas.drawCircle(7+(i*25), mBounceDotRadius, mBounceDotRadius, paint);
            }
            else {
                canvas.drawCircle(7+(i*25), mBounceDotRadius, mDotRadius, paint);
            }
        }
    }
